...
<head>
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page" style="background-image: url(images/admin-bg.jpg);background-size: cover;background-position: center;">
        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header no-border">
                <div class="card-title text-xs-center">
                    <div class="p-1"><img src="app-assets/images/logo/logo-blue.png" alt="branding logo" width="100%"></div>
                </div>
