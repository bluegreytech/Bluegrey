    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Quote Inquiry</h4>
                    ...
                    <table id="example" class="table">
                        ...
                        <tbody>
                            ...
                            ?>
                                    ...
                                    <td><?php echo $r1['MessageQuery']; ?></td>
...
<script>
    $('#example').dataTable( {
    "oLanguage": {
        "sLengthMenu": "Show _MENU_ Quote of Inquiry per page",
        "sInfo": "Showing _START_ to _END_ of _TOTAL_ Quote of Inquiry"
    }
    });
