...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2019 at 11:30 AM
...
INSERT INTO `tbluser` (`UserId`, `RoleId`, `StreamId`, `FirstName`, `LastName`, `EmailAddress`, `Password`, `PhoneNumber`, `Address`, `ProfileImage`, `Gender`, `City`, `ResetPasswordCode`, `IsActive`, `CreatedBy`, `CreatedOn`, `UpdatedBy`, `UpdatedOn`) VALUES
