<?php 
    ...
    if(isset($_POST['footersave']))
    {
        ...
        $result=mysqli_query($con,"insert into tblinquiry(FirstName,LastName,EmailAddress,MobileNumber,CountryId,IntrestedTypeId,DescriptionMessage)values('$FirstName','$LastName','$EmailAddress','$MobileNumber','$CountryId','$IntrestedTypeId','$DescriptionMessage')")or die(mysql_error());
        if($result)
        {   			
                $FROMNAME=FROMNAME;
                $USERNAME=USERNAME;
...
<li><a href="workstations-and-point-of-sale-systems">Workstation & POS Systems</a></li>
<li><a href="employee-productivity">Employee Productivity</a></li>
<li><a href="security-and-monitoring">Security System Monitoring Service</a></li>
<li><a href="network-infrastructure">Network Infrastructure</a></li>
<li><a href="data-protection-and-migration">Data Protection & Migration</a></li>
</ul>
</li>
<li class="has-dropdown"><a>Customer Support</a>
<ul class="sub-menu">
<li><a href="inbound-call-center-services">Inbound</a></li>
<li><a href="outbound-call-center">Outbound</a></li>
...
<div class="footer__address">
			...
			<a href="contact-us" class="all-link footer__link">
...
<nav class="nav-mobile">
	<div id="c-menu--push-left" class="c-menu c-menu--push-left is-active">
		<ul class="c-menu__items">
            ...
            <li class="menu-item has-dropdown">
                <a href="#">What We Do</a>
                <ul class="sub-menu">
                <li class="menu-item"><a href="web-solution">Web Solutions</a></li>
                <li class="menu-item"><a href="it-services">IT Services</a></li>
                <li class="menu-item"><a href="call-center-services">Call Center Services</a></li>
               </ul>
            </li>
            <li class="menu-item">
            ...
            <ul class="sub-menu">
            <li class="menu-item"><a href="about#heroAbout">About</a></li>
            <li class="menu-item"><a href="about#mission">Our Mission</a></li>
            <li class="menu-item"><a href="about#vision">Our Vision</a></li>
            <li class="menu-item"><a href="about#wedo">What We Do</a></li>
    ...
    <div class="nav-mobile__top">
        <a class="btn btn--menuLeft" href="contact-us">Contact Us</a>     <a id="closeBtn" href="#" class="btn-close"></a>
    </div>
